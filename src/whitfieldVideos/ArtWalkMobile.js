...
class ArtWalkMobile extends React.Component{
    constructor() {
        super();
        this.state = {
            show: false
        ...
        return (
            <div className="video-holder">
                <div className="home-video-holder">
                    <iframe className="home-video" src="https://player.vimeo.com/video/336352225" allow="autoplay; fullscreen" title="Secret Art Trail ~ Huntsville Alabama" frameBorder="0" allowFullScreen></iframe>
                </div>
