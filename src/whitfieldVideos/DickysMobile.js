        ...
        return (
            <div className="video-holder">
                <div className="home-video-holder">
                    <iframe className="home-video" src="https://player.vimeo.com/video/400668887" allow="autoplay; fullscreen" title="Dicky's Barbecue Pit ~ Huntsville Alabama" frameBorder="0" allowFullScreen></iframe>
                </div>
