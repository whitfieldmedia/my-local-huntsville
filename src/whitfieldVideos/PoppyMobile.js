...
class PoppyMobile extends React.Component{
    render() {
        return (
            <div className="video-holder">
                <div className="home-video-holder">
                    <iframe className="home-video" src="https://player.vimeo.com/video/336637294?title=0&byline=0&portrait=0" width="640" height="360" allow="autoplay; fullscreen" title="The Poppy ~ Huntsville Alabama" frameBorder="0" allowFullScreen></iframe>
                </div>
