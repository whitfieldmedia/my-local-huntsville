        ...
        return (
            <div className="video-holder">
                <div className="home-video-holder">
                    <iframe className="home-video" src="https://player.vimeo.com/video/400668887?autoplay=1&muted=1" allow="autoplay; fullscreen" title="Dickey's Barbecue Pit" frameBorder="0" allowFullScreen></iframe>
                </div>
