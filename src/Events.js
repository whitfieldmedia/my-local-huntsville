            ...
            <div className="events-container">
                ...
                <div className="events-page">
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                90’a Grunge Costume Party with FLANNEL
                            </h2>
                            <p className="event-date">
                                Friday March 13 at 10 PM
                            </p>
                            <a className="event-link"
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                St. Patrick's Day Madness (parade)
                            </h2>
                            <p className="event-date">
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                St. Patrick’s Day at Yellowhammer
                            </h2>
                            <p className="event-date">
                                Saturday March 14, 2 PM - 5 PM
                            </p>
                            <a className="event-link"
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                Live Music with Cheryl Llewellyn
                            </h2>
                            <p className="event-date">
                                Saturday March 14, 7 PM - 10 PM
                            </p>
                            <a className="event-link"
                                href="https://www.google.com/maps/place/The+Brass+Tap/@34.710398,-86.591248,17z/data=!4m5!3m4!1s0x88626d8425d326c1:0x13b41e2e27b67db8!8m2!3d34.7103936!4d-86.5890593"
                                target="_blank"
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                7th Annual Rocket 95.1 Kegs N Eggs
                            </h2>
                            <p className="event-date">
                                Saturday March 14, 7 PM - 10 PM
                            </p>
                            <a className="event-link"
                                href="https://www.google.com/maps/place/Below+the+Radar+Brewhouse/@34.7328612,-86.5876374,17z/data=!3m1!4b1!4m5!3m4!1s0x88626b515e53b43f:0xa1748840b10c8590!8m2!3d34.7328568!4d-86.5854487"
                                target="_blank"
                                rel="noopener noreferrer">
                                    Below The Radar
                            </a>
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                The Poppy St. Patrick’s Day Extravaganza!
                            </h2>
                            <p className="event-date">
                                Saturday March 14, 1 AM
                            </p>
                            <a className="event-link"
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                Them Damn Dogs Live at The Bar
                            </h2>
                            <p className="event-date">
                                Saturday March 14 at 10 PM - 1 AM
                            </p>
                            <a className="event-link"
                                href="https://www.google.com/maps/place/The+Bar+at+805/@34.7222006,-86.6068994,17z/data=!3m1!4b1!4m5!3m4!1s0x88626d55a1723b81:0x7af4f926062fc092!8m2!3d34.7221962!4d-86.6047107"
                                target="_blank"
                    ...
                    <div className="event-holder">
                        <div className="event-container">
                            <h2 className="event-title">
                                Mortgage Right Half Priced Headshot Marathon
                            </h2>
                            <p className="event-date">
                                Tuesday March 17, 9 AM - 3 PM
                            </p>
                            <a className="event-link"
                                href="https://www.google.com/maps/place/Heather+Edstrom+Photography/@34.7397178,-86.5964696,17z/data=!3m1!4b1!4m5!3m4!1s0x88626b86a26017d1:0x1651aeaff6406977!8m2!3d34.7397134!4d-86.5942809"
                                target="_blank"
                                rel="noopener noreferrer">
                                    Heather Edstrom Photography
                            </a>
                            <a className="event-link" href="https://www.facebook.com/events/2731934100209127/" target="_blank" rel="noopener noreferrer">
                                Reserve your spot
                            </a>
                        </div>
                    </div>
